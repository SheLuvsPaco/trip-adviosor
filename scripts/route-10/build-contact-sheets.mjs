...
const outputDir = path.join(ROOT, "tmp", "route-10-image-qa");
...
for (let offset = 0; offset < selections.length; offset += 18) {
  ...
  args.push("-thumbnail", "300x170>", "-background", "#111827", "-fill", "white", "-font", "/System/Library/Fonts/Supplemental/Arial.ttf", "-pointsize", "13", "-tile", "3x6", "-geometry", "300x205+8+8", destination);
  await run(args);
